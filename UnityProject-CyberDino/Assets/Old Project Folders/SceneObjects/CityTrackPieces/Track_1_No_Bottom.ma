...
//Last modified: Thu, Feb 20, 2014 02:59:44 PM
//Codeset: 1252
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -6.3206069413077994 37.408774201342027 29.163774432504923 ;
	setAttr ".r" -type "double3" -48.938352729855254 -14.199999999958006 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 44.525476364194802;
...
createNode transform -s -n "top";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.00053459569835116987 -16.985615597036784 -2.2876665839444144e-016 ;
	setAttr ".r" -type "double3" 89.999999999999986 179.99999999999997 0 ;
	setAttr ".rpt" -type "double3" -4.4154189595637176e-017 -1.3881103423370899e-016 
		2.2869258215797452e-016 ;
createNode camera -s -n "topShape" -p "top";
	...
	setAttr ".tp" -type "double3" 0.00053459569835325122 0.36972589790821075 3.8535858693475966e-015 ;
...
createNode polyTweak -n "polyTweak5";
	setAttr ".uopa" yes;
	setAttr -s 9 ".tk[39:47]" -type "float3"  -2.29542089 0 0 -2.28348947
		 0 0 -2.28348947 0 0 -2.28348947 0 0 -2.28348947 0 0 2.29542089 0 0 2.29542089 0 0
		 2.29542089 0 0 2.29542089 0 0;
...
createNode polyAppend -n "polyAppend1";
	setAttr -s 3 ".d[0:2]"  -2147483648 -2147483640 -2147483638;
	setAttr ".tx" 1;
...
createNode polyAppend -n "polyAppend2";
	setAttr -s 3 ".d[0:2]"  -2147483631 -2147483632 -2147483574;
	setAttr ".tx" 1;
...
createNode polyAppend -n "polyAppend3";
	setAttr -s 3 ".d[0:2]"  -2147483607 -2147483609 -2147483573;
	setAttr ".tx" 1;
...
createNode polyAppend -n "polyAppend5";
	setAttr -s 3 ".d[0:2]"  -2147483575 -2147483576 -2147483571;
	setAttr ".tx" 1;
...
createNode polyAppend -n "polyAppend7";
	setAttr -s 3 ".d[0:2]"  -2147483614 -2147483616 -2147483568;
	setAttr ".tx" 1;
...
createNode polyAppend -n "polyAppend8";
	setAttr -s 4 ".d[0:3]"  -2147483627 -2147483566 -2147483630 -2147483623;
	setAttr ".tx" 1;
...
connectAttr "polyMergeVert16.out" "polyAppend1.ip";
