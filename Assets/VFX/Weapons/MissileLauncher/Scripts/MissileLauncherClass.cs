...
public class MissileLauncherClass : RangedWeaponClass {
...
//		}
	...
	public void ProjectileFunc(){
		...
		ProjectileMissileLauncherClass theProj = spawnedProj.gameObject.GetComponent<ProjectileMissileLauncherClass>();
